...
# Author: Waseem Patel
# Date: 09/06/2026
# Purpose: To create a Math quiz / game to help students have fun doing math in an interactive way while still giving them a challenge
'''
...
LOGIN_INFORMATION = "LoginInfo.txt"

# This is my main class, which runs the entire program.
class MathQuizApp:
    def __init__(self):
        self.root = tk.Tk()
    ...
    # This removes all widgets on the screen which is open.
    def clear_screen(self):
        for widget in self.main_frame.winfo_children():
            widget.destroy()

    # This creates the visual hover effect when hovering over a button.
    def button_enter(self, event):
            event.widget.config(bg = "#f2f2f2")
    
    def button_leave(self, event):
            event.widget.config(bg = "#CFF2FF")
    
    def add_hover_effect(self, button):
            button.bind("<Enter>", self.button_enter)
            button.bind("<Leave>", self.button_leave)

    # This creates the shape, colour, size, etc of the buttons on the menu.
    def create_menu_buttons(self, text, y_position, command):
        button = tk.Button(self.main_frame, text = text, font = ("Georgia", 25, "bold") , bg = "#CFF2FF", 
        fg = TEXT_COLOUR, activebackground = "#f2f2f2", activeforeground = TEXT_COLOUR, relief = "solid", borderwidth = 1, command = command)

        button.place(x = BUTTON_X, y = y_position, width = BUTTON_WIDTH, height = 68)
    ...
    def main(self):
        ...
        title_label = tk.Label(self.main_frame, text = "Welcome to the Math Quiz", font = ("Georgia", 28, "bold"), 
        bg= "#87CEEB", fg = TEXT_COLOUR)

        title_label.place(x = 0, y = 20, width = WINDOW_WIDTH, height = 45)

        self.create_menu_buttons("Sign Up", 120, self.open_sign_up)
        self.create_menu_buttons("Log in", 230, self.open_log_in)
        self.create_menu_buttons("Leaderboard", 338, self.open_leaderboard)
        self.create_menu_buttons("Exit", 442, self.exit_program)
    ...
    def open_sign_up(self):
        ...
        button_signup = tk.Button(self.main_frame, text = "Confirm", fg = "#000000", font = TITLE_FONT, bg = "#CFF2FF", 
        relief = "solid", borderwidth = 1, command = self.save_signup)

        self.add_hover_effect(button_signup)
    ...
    def save_signup(self):
        ...
        if len(username) < 5:
            messagebox.showerror("Error", "Username must be 5 or more characters.")
            return
        ...
        if len(password) < 5:
            messagebox.showerror("Error", "Password must be 5 or more characters.")
            return
    ...
    def open_log_in(self):
        ...
        button_login = tk.Button(self.main_frame, text = "Confirm", fg = "#000000", font = TITLE_FONT, bg = "#CFF2FF", 
        relief = "solid", borderwidth = 1, command = self.check_login)

        self.add_hover_effect(button_login)
    ...
    def difficulty_selection(self):
        ...
        title_label = tk.Label(self.main_frame, text = "<Choose Your Difficulty>", font = TITLE_FONT, 
        bg = "#87CEEB", fg = TEXT_COLOUR, height = 50)

        title_label.place(x = 0, y = 40, width = WINDOW_WIDTH, height = 50)

        note_label = tk.Label(self.main_frame, text = "Note: Use special symbols according to the question", 
        font = ("Arial", 26, "bold"), bg = "#87CEEB", fg = TEXT_COLOUR, height = 50)

        note_label.place(x = 0, y = 120, width = WINDOW_WIDTH, height = 50)

        self.login_back_button()

        self.difficulty_box = tk.Listbox(self.main_frame, font = ("Arial", 28, "bold"), bg = "white", fg = "black", 
        ...
        button_confirm = tk.Button(self.main_frame, text = "Confirm", fg = "#000000", font = TITLE_FONT, 
        bg = "#CFF2FF", relief = "solid", borderwidth = 1, command = self.check_difficulty)

        button_confirm.place(x = 320, y = 400, width = 250, height = 50)
        self.add_hover_effect(button_confirm)
    ...
    def check_difficulty(self):
        ...
        # This directs the user to the math quiz depending on the difficulty chosen.
    ...
    # This function displays the entire math quiz, depending on the difficulty.
    def math_quiz(self, difficulty):
        ...
        # These are all the easy mode questions for the quiz.
        self.easy_questions = [
        ...
        # These are all the medium mode questions for the quiz.
    ...
    {"question": "\nTwo dice are rolled. Find the probability of a total of 8.", "answer": "5/36", "unit": "", "image": "images/medium25.png"
    },
    ...
    {"question": "\nWhat is the smallest number greater than 50 that is a multiple of both 6 and 8?", "answer": "72", "unit": "", "image": "images/medium30.png"
        ...
        # These are all the hard mode questions for the quiz.
        self.hard_questions =  [
    ...
    {"question": "\n3 red and 2 blue counters. Two counters are taken, what is the probability that both are red?", "answer": "3/10", "unit": "", "image": "images/hard25.png"
    },
    {"question": "\nUse two-way table to find the probability that a randomly chosen student is a girl who passed.", "answer": "21/50", "unit": "", "image": "images/hard26.png"
    },
    ...
    {"question": "\nWhat is the smallest whole number that must multiply 180 to make a perfect square?", "answer": "5", "unit": "", "image": "images/hard30.png"
        ...
        # This selects the questions depending on the difficulty chosen.
        if difficulty == "Easy":
        ...
        self.question_title = tk.Label(self.main_frame , text = "Question 1" , font = ("Arial" , 25 , "bold") , 
        bg = "#87CEEB" , fg = "black")

        self.question_title.place(x = 0 , y = 15 , width = 900 , height = 45)

        # This creates the large box where the entire quiz is displayed.
        quiz_frame = tk.Frame(self.main_frame , relief = "solid" , borderwidth = 1)
        quiz_frame.place(x = 55 , y = 70 , width = 790 , height = 470)

        # This displays the difficulty if the quiz.
        difficulty_label = tk.Label(quiz_frame , text = "Difficulty: " + difficulty , font = ("Arial" , 15 , "bold") , 
        relief = "solid" , borderwidth = 1)

        difficulty_label.place(x = 15 , y = 35 , width = 210 , height = 45)

        # This displays the name of the user when doing the quiz.
        username_label = tk.Label(quiz_frame , text = "Username: " + self.current_username , font = ("Arial" , 14 , "bold") , 
        relief = "solid" , borderwidth = 1)

        username_label.place(x = 15 , y = 100 , width = 210 , height = 45)

        # This allows for the 5 minutes timer to be displayed.
        self.timer_label = tk.Label(quiz_frame , text = "Time Remaining: 5:00" , font = ("Arial", 14, "bold") , 
        relief = "solid" , borderwidth = 1)

        self.timer_label.place(x = 15 , y = 165 , width = 210 , height = 45)

        # This allows for the users score to be displayed in its box.
        self.score_label = tk.Label(quiz_frame , text = "Score: 0" , font = ("Arial" , 14 , "bold") , 
        relief = "solid" , borderwidth = 1)

        self.score_label.place(x = 15 , y = 230 , width = 210 , height = 45)

        # This creates the box where the lives / hearts go into.
        ...
        # This allows for the image of the heart to be dislayed.
        ...
        # This is the creation and placement of the first heart.
        self.heart_one = tk.Label(lives_box , image = self.heart_image)
        self.heart_one.place(x = 70 , y = 17 , width = 40 , height = 40)

        # This is the creation and placement of the second heart.
        self.heart_two = tk.Label(lives_box , image = self.heart_image)
        self.heart_two.place(x = 115 , y = 17 , width = 40 , height = 40)

        # This is the creation and placement of the third heart.
        self.heart_three = tk.Label(lives_box , image = self.heart_image)
        self.heart_three.place(x = 160 , y = 17 , width = 40 , height = 40)

        # This section allows for all the questions in the quiz to be displayed.
        self.question_label = tk.Label(quiz_frame , text = "", font = ("Arial" , 14 , "bold") , wraplength = 480 , justify = "center")
        self.question_label.place(x = 265 , y = 60 , width = 485 , height = 70)

        # This allows for the image correlated with the question to be displayed.
        ...
        # This displays the text on the left of the answer box.
        ...
        # This displays the unit beside the answer box, when the question is associated with units.
        self.unit_label = tk.Label(quiz_frame , text = "" , font = ("Arial" , 18 , "bold") , anchor = "w")
        self.unit_label.place(x = 650 , y = 285 , width = 80 , height = 45)

        # This section displays whether the inputted answer is either Correct, Wrong, or an invalid input.
        self.feedback_label = tk.Label(quiz_frame , text = "" , font = ("Arial" , 15 , "bold"))
        self.feedback_label.place(x = 300 , y = 330 , width = 420 , height = 35)

        # This allows for the answer to be submitted when the button is pressed.
        self.submit_button = tk.Button(quiz_frame , text = "Submit Answer" , font = ("Arial" , 16 , "bold") , 
        relief = "solid" , borderwidth = 2)
        self.submit_button.place(x = 390 , y = 380 , width = 220 , height = 55)

        # This button allows the user to exit the quiz, and places the button on the top right of the quiz.
        exit_button = tk.Button(quiz_frame , text = "Exit" , font = ("Arial" , 17 , "bold") , relief = "solid" , 
        borderwidth = 2, bg ="#FF0000")
        exit_button.place(x = 620 , y = 15 , width = 150 , height = 45)

        # This function displays the question the user is on.
        def show_question():
            ...
            try:
                ...
                self.question_image_label.config (image = "" , text = "Image not found" , font = ("Arial" , 14 , "bold"))
        ...
        # This function displays a screen which is automatically visible when the quiz has been completed or lost.
        ...
        # This section allows the quiz to move to the next question after it is either correct or wrong.
        ...
        def check_answer():
            ...
            # This validates the input from the user, only allowing numbers and symbols related to math.
            if typed_answer == "":
            ...
            if any(character not in "0123456789/.-" for character in typed_answer):
                self.feedback_label.config(text="Please enter a valid number or fraction.")
                return

            self.waiting_for_next = True

            # This section checks the user's answer to see if it is correct.
            if typed_answer == correct_answer:
                ...
                # This section removes a heart when the user gets an answer wrong.
                if self.lives == 2:
            ...
            # The section ends the quiz when the user runs out of lives.
            if self.lives == 0:
        ...
        # This section creates and controls the 5 minute timer.
        def update_timer():
            self.timer_job = None
            ...
            # This displays when the user runs out of time.
            if self.time_left == 0:
        ...
        # This allows for the user to exit the quiz back to the difficulty selection screen.
        def exit_quiz():
        ...
        # This line allows for the user to also click "Enter" on the keyboard to submit their answer.
        self.answer_entry.bind("<Return>" , lambda event: check_answer())

        # This displays the first question and starts the timer when the quiz has begun.
        show_question()
        update_timer()

    # This section saves the result of the quiz when finished.
    def save_leaderboard_result(self):
        total_questions = len(self.questions)

        # This part calculates how long the user took doing the quiz.
        time_used = 300 - self.time_left

        LEADERBOARD_INFORMATION = open("Leaderboard.txt" , "a")

        LEADERBOARD_INFORMATION.write(self.current_difficulty + "," +
        self.current_username + "," + str(self.score) + "," + str(total_questions) + "," + str(time_used) + "\n")
        LEADERBOARD_INFORMATION.close()

    # This function displays the result depending on the difficulty chosen.
    def display_leaderboard(self, event = None):
        ...
        try:
            LEADERBOARD_INFORMATION = open("Leaderboard.txt" , "r")
            saved_results = LEADERBOARD_INFORMATION.readlines()
            LEADERBOARD_INFORMATION.close()

        except FileNotFoundError:
            saved_results = []

        # This stores the best result from each username, ensuring that usernames do not overlap.
        best_results = {}
        ...
        for result in saved_results:
            ...
            if len(details) == 5:
                ...
                if difficulty == selected_difficulty:
                    ...
                    # This adds the user to the leaderboard, if they have no score yet.
                    if username not in best_results:
                        ...
                        # This ensures that the higher score is the better option.
                        if score > old_score:
                            best_results[username] = [score , total_questions , time_used]

                        # This ensures that faster times are important when scores are equal.
        ...
        # This code is for users who get the same score, this code chooses the one with the faster time to be on top of the leaderboard.
        ...
        # This function displays the users final score after the quiz has ended.
    def show_results_page(self):
        ...
        # This section displays the end screen when the time runs out, or you lose all 3 lives.
        if seconds<10:
            displayed_time = str(minutes) + ":0"+str(seconds)
        else:
            displayed_time = str(minutes) + ":"+str(seconds)
        ...
        # This displays the screen after the user finishes or loses the quiz, instantly displaying their score, time, username, and their result.
        title_label = tk.Label(self.main_frame , text = "Results Page: " + result_message , font = ("Arial" , 27 , "bold") , 
        bg= "#87CEEB" , fg="black")
        title_label.place(x = 0 , y = 45 , width = 900 , height = 50)

        difficulty_label = tk.Label(self.main_frame , text = "This is your Final Score on " + self.current_difficulty + " Difficulty:" , 
        font = ("Arial" , 22) , bg = "#87CEEB" , fg = "black")
        difficulty_label.place(x = 0 , y = 115 , width = 900 , height = 55)

        username_heading = tk.Label(self.main_frame , text = "Username" , font = ("Arial" , 18 , "bold") , 
        bg = "white" , relief = "solid" , borderwidth = 1)
        username_heading.place(x = 98 , y = 220 , width = 263 , height = 75)

        score_heading = tk.Label(self.main_frame , text = "Score" , font = ("Arial" , 18 , "bold") , 
        bg = "white" , relief = "solid" , borderwidth = 1)
        score_heading.place(x = 361 , y = 220 , width = 165 , height = 75)

        time_heading = tk.Label(self.main_frame, text = "Time" , font = ("Arial" , 18 , "bold") , 
        bg = "white" , relief = "solid" , borderwidth = 1)
        time_heading.place(x = 526 , y = 220 , width = 278 , height = 75)

        username_result = tk.Label(self.main_frame , text = self.current_username , font = ("Arial" , 18) , 
        bg = "white" , relief = "solid" , borderwidth = 1)
        username_result.place(x = 98 , y = 295 , width = 263 , height = 75)

        score_result = tk.Label(self.main_frame , text = str(self.score) + "/" + str(total_questions) , font = ("Arial" , 18) , 
        bg = "white" , relief = "solid" , borderwidth = 1)
        score_result.place(x = 361 , y = 295 , width = 165 , height = 75)

        time_result = tk.Label(self.main_frame , text = displayed_time , font = ("Arial" , 18) , 
        bg = "white" , relief = "solid" , borderwidth = 1)
        time_result.place(x = 526 , y = 295 , width = 278 , height = 75)

        main_menu_button = tk.Button(self.main_frame , text = "Main Menu" , font = ("Arial" , 18 , "bold") , 
        bg = "#CFF2FF" , fg = "black" , relief = "solid" , borderwidth = 1 , command = self.main)
        main_menu_button.place(x = 350 , y = 460 , width = 203 , height = 50)

        # This allows for the leaderboard to be opened and seen when clicked by users.
    def open_leaderboard(self):
        self.clear_screen()

        # This displays and places the title when leaderboard button is pressed.
        title_label = tk.Label(self.main_frame , text = "Leaderboard of All Users" , font = ("Arial" , 28 , "bold") , 
        bg = "#87CEEB" , fg = "black")

        title_label.place(x = 0 , y = 15 , width = 900 , height = 45)

        # This displays the difficulty label.
        difficulty_label = tk.Label(self.main_frame , text = "Difficulty:" , font = ("Arial" , 22 , "bold") , 
        bg = "#87CEEB" , fg = "black")

        difficulty_label.place(x = 235 , y = 90 , width = 190 , height = 55)

        # This creates the dropdown box, allowing users to see scores between the difficulties.
        self.leaderboard_difficulty_box = ttk.Combobox(self.main_frame , values = ["Easy" , "Medium" , "Hard"] , 
        state = "readonly" , font = ("Arial" , 18))

        self.leaderboard_difficulty_box.place(x = 425 , y = 95 , width = 270 , height = 45)

        # This automatically displays the "Easy" leaderboard when leaderboard is first opened.
        ...
        # This section adapts to the new scores, allowing the new scores to be organised in order.
        ...
        # This creates the leaderboard table, showing the best scores from users.
        self.leaderboard_table = ttk.Treeview(self.main_frame , columns = ("Username" , "Score" , "Time") , 
        show = "headings" , height = 7 , style = "Leaderboard.Treeview")
        ...
        exit_button = tk.Button(self.main_frame , text = "Exit" , font = ("Arial" , 18 , "bold") , 
        bg = "#FF0000" , fg = "black" , relief = "solid" , borderwidth = 1 , command = self.main)

        exit_button.place(x = 700 , y = 0 , width = 200 , height = 45)
...
# This creates the "Back" button allows for user to go back to the previous section.
    def create_back_button(self):
        back_button = tk.Button(self.main_frame, text = "Back", font = ("Arial", 28, "bold"), bg= "#FF0000", 
        fg=TEXT_COLOUR, activebackground = "#f2f2f2", relief = "solid", borderwidth = 1, command = self.main)
    ...
    def login_back_button(self):
        login_back_button = tk.Button(self.main_frame, text = "Back", font = ("Arial", 28, "bold"), bg = "#FF0000", 
        fg = TEXT_COLOUR, activebackground = "#f2f2f2", relief = "solid", borderwidth = 1, command = self.open_log_in)
