...
class MathQuizApp:
    ...
    def create_menu_buttons(self, text, y_position, command):
        button = tk.Button(self.main_frame, text = text, font = ("Georgia", 25, "bold") , bg = "#CFF2FF", fg = TEXT_COLOUR, activebackground = "#f2f2f2", activeforeground = TEXT_COLOUR, relief = "solid", borderwidth = 1, command = command)
    ...
    def open_sign_up(self):
        ...
        button_signup = tk.Button(self.main_frame, text = "Confirm", fg = "#000000", font = TITLE_FONT, bg = "#CFF2FF", relief = "solid", borderwidth = 1, command = self.save_signup)
    ...
    def open_log_in(self):
        ...
        button_login = tk.Button(self.main_frame, text = "Confirm", fg = "#000000", font = TITLE_FONT, bg = "#CFF2FF", relief = "solid", borderwidth = 1, command = self.check_login)
    ...
    def difficulty_selection(self):
        ...
        note_label = tk.Label(self.main_frame, text = "Note: Use special symbols according to the question", font = ("Arial", 26, "bold"), bg = "#87CEEB", fg = TEXT_COLOUR, height = 50)
        ...
        button_confirm = tk.Button(self.main_frame, text = "Confirm", fg = "#000000", font = TITLE_FONT, bg = "#CFF2FF", relief = "solid", borderwidth = 1, command = self.check_difficulty)
    ...
    {"question": "\nTwo dice are rolled. Find the probability of a total of 8.", "answer": "5/36", "unit": "", "image": "images/hard25.png"
    },
    ...
    {"question": "\nWhat is the smallest whole number that must multiply 180 to make a perfect square?", "answer": "5", "unit": "", "image": "images/hard30.png"
        ...
        exit_button = tk.Button(quiz_frame , text = "Exit" , font = ("Arial" , 17 , "bold") , relief = "solid" , borderwidth = 2, bg ="#FF0000")
...
self.current_username + "," + str(self.score) + "," + str(total_questions) + "," + str(time_used) + "\n")
    ...
    def show_results_page(self):
        ...
        main_menu_button = tk.Button(self.main_frame , text = "Main Menu" , font = ("Arial" , 18 , "bold") , bg = "#CFF2FF" , fg = "black" , relief = "solid" , borderwidth = 1 , command = self.main)
...
# This creates the "Back" button allows for user to go back to the previous section.
    def create_back_button(self):
        back_button = tk.Button(self.main_frame, text = "Back", font = ("Arial", 28, "bold"), bg= "#FF0000", fg=TEXT_COLOUR, activebackground = "#f2f2f2", relief = "solid", borderwidth = 1, command = self.main)
    ...
    def login_back_button(self):
        login_back_button = tk.Button(self.main_frame, text = "Back", font = ("Arial", 28, "bold"), bg = "#FF0000", fg = TEXT_COLOUR, activebackground = "#f2f2f2", relief = "solid", borderwidth = 1, command = self.open_log_in)
